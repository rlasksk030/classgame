...
export const SEED_PROBLEMS: SeedProblem[] = [
  ...
  // =========================================================================
  {
    ...
    startBlocks: [],
    given: {
      projections: { front: project(S3, G3).front },
      shownFrom: "front",
      allowRotate: true,
    },
    choices: [],
  ...
  },
  {
    ...
    startBlocks: [],
    given: {
      projections: { side: project(S3, G3).side },
      shownFrom: "right",
      allowRotate: true,
    },
    choices: [],
  ...
  // =========================================================================
  {
    ...
    prompt:
      "지금은 화면을 돌릴 수 없습니다.\n지금 앞에서 본 모양만으로 쌓기나무의 전체 개수를 정확히 알 수 있을까요?",
    grid: G4,
    givenBlocks: S7,
    startBlocks: [],
    given: { projections: { front: project(S7, G4).front }, allowRotate: false, note: "이 문제에서는 화면을 돌릴 수 없어요." },
    choices: ["알 수 있어요", "알 수 없어요"],
