...
export interface Building { building_name:string;reason:string;description:string;layer_notes:string[];blocks:BlockCoord[];version:number;submitted:boolean;grid_width?:number;grid_depth?:number;max_height?:number }
export const EMPTY_BUILDING:Building={building_name:'',reason:'',description:'',layer_notes:['','',''],blocks:[],version:0,submitted:false,grid_width:ARCHITECTURE_GRID.gridWidth,grid_depth:ARCHITECTURE_GRID.gridDepth,max_height:ARCHITECTURE_GRID.maxHeight};
