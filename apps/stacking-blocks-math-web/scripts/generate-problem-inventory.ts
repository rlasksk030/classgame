...
const activities: InventoryEntry[] = [
  ...
  // 2026-09-24: UI removed (route deleted); sb_worksheet_imports table/storage kept intact for data preservation.
  { lessonId: 0, stage: "teacher", problemId: "activity:worksheet-import", sourceType: "WORKSHEET_IMPORT", problemVersion: "activity-v1", questionIntent: "학습지 문제를 교사가 검토·수정한 뒤 등록", evidence: ["PDF/image preview", "manual crop", "review form"], answerInput: "MANUAL_REVIEW", gradingMode: "teacher configured", revealMode: "answer-specific material", completion: "검토 후 문제은행 등록", route: null, status: "NOT_STARTED" },
];
