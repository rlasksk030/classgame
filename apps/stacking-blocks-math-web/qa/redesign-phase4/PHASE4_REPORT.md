...
공통 6개와 seed 기반 맞춤 4개를 고정 순서로 제공하며, 방향·숫자·세 방향 격자·층별 격자 답안을 실제 입력할 수 있다. 맞춤 연습 5·10·15·20 선택과 자기평가 저장 UI도 제공한다. 답안별 서버 저장·개념 태그 기반 실제 적응 배정은 원격 API 미연결 상태다.
...
- 검증 코드 HEAD: 62c59339ec1f6078d26ce9762332e68d1ed9d140
