...
type ProjectState = { id: string; version: number; name: string; reason: string; description: string; blocks: BlockCoord[]; layerNotes: string[]; gridWidth: number; gridDepth: number; maxHeight: number; appearance: Record<string, RewardMaterial>; };
const EMPTY_PROJECT: ProjectState = { id: 'local-project', version: 0, name: '', reason: '', description: '', blocks: [], layerNotes: ['', '', ''], gridWidth: 10, gridDepth: 10, maxHeight: 12, appearance: {} };
