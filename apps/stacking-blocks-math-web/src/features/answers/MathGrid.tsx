...
interface Props {face?:'top'|'front'|'side';title:string;rows:(boolean|number)[][];numeric?:boolean;maximum?:number;floor?:boolean;readOnly?:boolean;onChange?:(row:number,col:number,value:boolean|number)=>void;onCell?:(row:number,col:number)=>void;marked?:boolean[][];}
