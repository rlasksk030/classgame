...
export default function ActivityBuilder({blocks,onChange,disabled=false,answer}:{blocks:BlockCoord[];onChange:(blocks:BlockCoord[])=>void;disabled?:boolean;answer?:BlockCoord[]}) {
 ...
 <BlockWorld grid={ACTIVITY_GRID} blocks={blocks} selected={selected} layerMax={null} preset={preset} onPreset={setPreset} onBlocksChange={change} onSelect={setSelected} onMessage={setMessage} disabled={disabled} answerGhost={answer}/>
