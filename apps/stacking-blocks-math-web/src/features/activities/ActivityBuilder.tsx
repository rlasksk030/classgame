...
export default function ActivityBuilder({blocks,onChange,disabled=false,answer,grid=ACTIVITY_GRID,appearance,onAppearanceChange,allowedMaterials,activeMaterial,cameraPolicy}:{blocks:BlockCoord[];onChange:(blocks:BlockCoord[])=>void;disabled?:boolean;answer?:BlockCoord[];grid?:{gridWidth:number;gridDepth:number;maxHeight:number};appearance?:Record<string,RewardMaterial>;onAppearanceChange?:(next:Record<string,RewardMaterial>)=>void;allowedMaterials?:RewardMaterial[];activeMaterial?:RewardMaterial;cameraPolicy?:CameraPolicy}) {
